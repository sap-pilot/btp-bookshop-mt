...
const APP_NAME = "BTP-Bookshop-MT-app"; // local app name the route should bind to, should match mta.yaml approuter name
...
const URL_APP_NAME = "bshop"; // short app name to identify the app in URL, must match mta.yaml TENANT_HOST_PATTERN
